...
const dropdownItems = [
  { type: "item", value: "edit", label: "Edit", disabled: true },
  { type: "item", value: "duplicate", label: "Duplicate", disabled: false },
  { type: "separator" },
  { type: "item", value: "archive", label: "Archive", disabled: false },
          ...
          {dropdownItems.map((item, idx) => {
            ...
            return (
              <DropdownItem
                ...
                className="relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground disabled:text-red-400 disabled:pointer-events-none disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0"
