 ...
 *
 * @element new-accordion-trigger
 *
 * @example
 * ```html
 * <new-accordion-trigger>Click me</new-accordion-trigger>
 * ```
 */
@customElement("new-accordion-trigger")
export class NewAccordionTrigger extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "new-accordion-trigger": NewAccordionTrigger;
  }
}
