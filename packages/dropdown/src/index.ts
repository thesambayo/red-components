...
export const DropdownRoot = createComponent({
  ...
  react: React,
  events: {
    onOpen: DROPDOWN_EVENTS.OPEN as EventName<CustomEvent>,
    onClose: DROPDOWN_EVENTS.CLOSE as EventName<CustomEvent>,
  },
});
...
export const DropdownItem = createComponent({
  ...
  react: React,
  events: {
    onSelect: DROPDOWN_EVENTS.ITEM_SELECT as EventName<CustomEvent>,
  },
});
